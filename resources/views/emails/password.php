                ...
                <table class="twelve columns" style="border-spacing: 0;border-collapse: collapse;padding: 0;vertical-align: top;text-align: left;margin: 0 auto;width: 580px;">
                    <tr style="padding: 0;vertical-align: top;text-align: left;">
                        <td style="word-break: break-word;-webkit-hyphens: auto;-moz-hyphens: auto;hyphens: auto;padding: 0px 0px 10px;vertical-align: top;text-align: left;color: #222222;font-family: 'Helvetica', 'Arial', sans-serif;font-weight: normal;margin: 0;line-height: 21px;font-size: 15px;border-collapse: collapse!important;">
                            ...
                            <br>
                            <p class="lead" style="margin: 0;margin-bottom: 15px;color: #222222;font-family: 'Helvetica', 'Arial', sans-serif;font-weight: normal;padding: 0;text-align: left;line-height: 24px;font-size: 20px;">A password reset request was received for your account. <br>Please ignore it if you did not initiate this request.</p>
                            <p style="margin: 0;margin-bottom: 15px;color: #222222;font-family: 'Helvetica', 'Arial', sans-serif;font-weight: normal;padding: 0;text-align: left;line-height: 21px;font-size: 15px;">Please open the following URL to begin the password reset process: </p>
                            <p style="margin: 0;margin-bottom: 15px;color: #222222;font-family: 'Helvetica', 'Arial', sans-serif;font-weight: normal;padding: 0;text-align: left;line-height: 21px;font-size: 15px;"><a href="<?php echo 'http://'.$_SERVER['HTTP_HOST'].'/#/auth/recover/?token=' . $token . '&email=' . $user->email; ?>" style="color: #2ba6cb;text-decoration: none;"><?php echo 'http://'.$_SERVER['HTTP_HOST'].'/#/auth/recover/?token=' . $token . '&email=' . $user->email; ?></a></p></p>
                        </td>
